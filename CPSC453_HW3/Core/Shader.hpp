...
public:
	...
	*/
    ...
    Shader(const std::string& vShaderFile, const std::string& fShaderFile, const std::string& gShaderFile);
	...
	*/
    ...
    /*
        ...
        return:
            The programID openGL allocates
    */
    static GLuint LinkProgram(const GLuint vShader, const GLuint fShader, const GLuint gShader);
    ...
    /*
        ...
        return:
            The programID openGL allocates for the program
    */
    static GLuint BuildProgram(const std::string& vShaderFile, const std::string& fShaderFile, const std::string& gShaderFile);
};
