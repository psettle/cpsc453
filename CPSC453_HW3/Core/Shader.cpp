...
{
    this->programID = Shader::BuildProgram(vShaderFile, fShaderFile, gShaderFile);
}
...
GLuint Shader::LinkProgram(const GLuint vShader, const GLuint fShader, const GLuint gShader)
{
    /* allocate a program */
    GLuint program;
    program = glCreateProgram();
...
GLuint Shader::BuildProgram(const std::string& vShaderFile, const std::string& fShaderFile, const std::string& gShaderFile)
{
    /* compile the vertex shader */
    GLuint vertexShader = Shader::CompileShader(vShaderFile, GL_VERTEX_SHADER);
    /* compile the fragment shader */
    ...
    GLuint geometryShader = Shader::CompileShader(gShaderFile, GL_GEOMETRY_SHADER);
    /* link the programs and return the program ID */
    return Shader::LinkProgram(vertexShader, fragmentShader, geometryShader);
}
