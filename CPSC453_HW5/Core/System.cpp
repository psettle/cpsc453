...
/**********************************************************
                        CONSTANTS
**********************************************************/
static const std::string WINDOW_NAME = "CPSC453_HW5";
...
System::System()
{
    ...
    glfwSetInputMode(pWindowM, GLFW_CURSOR, GLFW_CURSOR_HIDDEN);
...
void System::Frame()
{
    ...
    glfwSetCursorPos(pWindowM, WINDOW_WIDTH / 2.0f, WINDOW_HEIGHT / 2.0f);
